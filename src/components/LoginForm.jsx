...
const LoginForm = () => {
  return (
    <div className="bg-white shadow-lg rounded-md flex pb-10 flex-col items-center gap-4 w-full sm:w-[450px]">
      ...
      <form className="w-full flex flex-col items-center gap-3 px-5">
